  ...
  return (
    <div className="admin-bg">
      <div className="admin-card">
        ...
        <p className="admin-subtitle">Jewellery Management System</p>

        {message && <div className="alert admin-alert">{message}</div>}
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button className="btn admin-btn w-100" type="submit">
            Login as Admin
          </button>
        </form>
      </div>
