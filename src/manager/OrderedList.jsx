...
import "../manager/OrderedList.css";
export default function OrderedList() {
  ...
  const fetchOrders = async () => {
    try {
      const res = await axios.get("https://smithtask-server.vercel.app/api/orders");
   ...
   const handleDelete = async (orderId) => {
    ...
    try {
      await axios.delete(`https://smithtask-server.vercel.app/api/orders/${orderId}`);
