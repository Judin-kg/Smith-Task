...
import "../adminpages/SmithList.css";
const SmithList = () => {
  ...
  const handleSaveSmith = async (data) => {
    try {
      await axios.get("https://smithtask-server.vercel.app/api/smiths", data);
      fetchSmiths();
      setShowForm(false);
    } catch (err) {
  ...
  const handleDeleteProduct = async (id) => {
    try {
      await axios.delete(`https://smithtask-server.vercel.app/api/smiths/${id}`);
