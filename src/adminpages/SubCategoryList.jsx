...
useEffect(() => {
  ...
  const handleSaveCategory = async (data) => {
    try {
      const res = await axios.get("https://smithtask-server.vercel.app/api/subcategories", data);
...
//   };
   ...
   // Delete product
    const handleDeleteProduct = async (id) => {
      try {
        await axios.delete(`https://smithtask-server.vercel.app/api/subcategories/${id}`);
